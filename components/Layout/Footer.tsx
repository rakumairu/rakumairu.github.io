const Footer = () => {
    ...
    return (
        ...
        <div className="relative w-full bg-main clip-top pt-12 md:pt-20 pb-4">
            <span className="arrow-up absolute top-0 transform -translate-x-1/2 mt-5 -ml-3 bounce cursor-pointer" style={{ left: '50%' }} onClick={() => scrollTop()} />
            <div className="container">
                <div className="lg:mx-32">
                    ...
                    <div className="flex flex-col text-white items-start mb-6">
                        ...
                        <a href="https://goo.gl/maps/SwoEksDpGUpk9d2q7" className="md:text-lg leading-tight font-semibold" target="__blank">Jakarta, Indonesia</a>
                        <a href="mailto:rakumairu.dev@gmail.com" className="text-xl md:text-3xl leading-snug font-bold underline-link" target="__blank">rakumairu.dev@gmail.com</a>
                    </div>
                    <div className="flex items-center" style={{ filter: 'brightness(0) saturate(100%) invert(100%) sepia(3%) saturate(12%) hue-rotate(103deg) brightness(105%) contrast(105%)' }}>
                        ...
                        <div className="hidden md:flex ml-auto items-center">
                            <a href="https://github.com/rakumairu" target="__blank">
                            ...
                            <a href="https://www.linkedin.com/in/demaspira/" target="__blank">
